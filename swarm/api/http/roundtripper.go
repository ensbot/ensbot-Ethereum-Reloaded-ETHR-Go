...
see https://github.com/Ethereum-Reloaded/ETHR-Go/issues/2040
Usage:

import (
 "github.com/Ethereum-Reloaded/ETHR-Go/common/httpclient"
 "github.com/Ethereum-Reloaded/ETHR-Go/swarm/api/http"
)
